...
const Card = ({
  ...
  return (
    <div
      className={cn(
        "bg-[#FFD6F6] md:max-w-6xl m-auto rounded-[50px] md:mt-[40px] flex md:flex-row flex-col relative md:px-[70px] md:pb-0 items-center p-6 mb-8 md:mb-0",
        className
      )}
    >
      {children}
...
export function Observation() {
  return (
    <section className="bg-primary md:pb-[80px] md:px-[80px] md:mt-[80px] mt-16">
      <div className="flex justify-center items-center flex-col space-y-2 md:max-w-6xl m-auto">
