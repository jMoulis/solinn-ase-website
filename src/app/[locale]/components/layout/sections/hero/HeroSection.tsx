    ...
    <section className="flex bg-primary justify-between md:pt-[80px] md:px-[80px]">
      <article className="space-y-6 md:w-[50%]">
        <BodyXLMD className="md:w-[494px]">
          Vous êtes un service de l&apos;aide sociale à l&apos;enfance.
        </BodyXLMD>
        ...
        <BodyMD>
          ...
          les acteurs de l&apos;aide sociale à l&apos;enfance. Des outils ancrés
          dans vos réalités de terrain, pensés vulnérabilités. Des outils ancrés
          dans vos réalités de terrain, pensés pour fluidifier vos actions,
          renforcer vos liens, et libérer du temps pour ce qui compte vraiment :
          l’humain. Des solutions simples, efficaces, respectueuses de vos
          pratiques.
        </BodyMD>
        <Link
          href="#solutions"
