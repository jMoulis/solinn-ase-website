  ...
  return (
    ...
    >
      <article>
        ...
        <div className="flex md:mt-20 mt-8 md:space-x-16 space-x-8 relative md:max-w-6xl m-auto">
          <Image
            src={workersImage}
      ...
      <article className="md:mt-16 mt-8 space-y-4 flex flex-col items-center border-b-2 md:pb-[100px] md:max-w-6xl m-auto pb-[60px] w-full">
      ...
      <article className="space-y-4 md:pt-[100px] pt-[60px] md:flex md:flex-col md:items-center md:max-w-6xl m-auto">
