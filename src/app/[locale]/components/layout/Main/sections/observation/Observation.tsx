...
import { CurlyLineBlack } from './CurlyLineBlack';
export function Observation() {
  return (
    <section className='bg-primary md:pb-[80px]  md:px-[80px]'>
      ...
      <div className='bg-[#FFD6F6] rounded-[50px] md:mt-[40px] flex md:flex-row flex-col relative md:px-[70px] items-center'>
      ...
      <div className='bg-secondary rounded-[50px] md:pt-[40px] md:mt-[40px] flex md:flex-row flex-col md:px-[70px] overflow-hidden'>
        ...
        <div className='flex flex-col  items-center transform md:translate-x-[40px]'>
          <BodyMD className='md:w-[131px]'>
            + de xxxx enfants sont lorem ipsum
          </BodyMD>
          <PointingArrowUp />
        </div>
        <Image
