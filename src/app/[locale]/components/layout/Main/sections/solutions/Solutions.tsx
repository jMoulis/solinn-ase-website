...
export function Solutions() {
  return (
    <section
      id='solutions'
      className='flex flex-col items-center justify-center bg-[#FEFDF6] py-[80px] px-[20px] md:px-[80px]'>
      <article>
        ...
        <div className='flex mt-20 space-x-16 relative'>
          <Image
            src={workersImage}
          ...
          <div className='space-y-6 relative'>
            ...
            <div className='relative'>
              <div className='absolute right-0 top-[50px] flex items-center space-x-4'>
                <PointingArrow />
      ...
      <article className='mt-16 space-y-4 flex flex-col items-center border-b-2 md:pb-[100px]'>
      ...
      <article className='space-y-4 md:pt-[100px]'>
